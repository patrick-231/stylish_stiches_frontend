      ...
      <div className='py-12 mx-auto '>
        ...
        <div className='grid grid-cols-1 xs:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-6 mt-8 '>
          {relatedProducts.map(product => (
            <div key={product.id} className='bg-white p-4 rounded-3xl shadow-md items-baseline bold-28 sm:bold-32 '>
              <img src={product.image} alt={product.name} className='w-full h-30 object-cover mb-2 rounded-3xl hover:scale-95' />
