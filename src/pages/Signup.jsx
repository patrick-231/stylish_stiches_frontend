  ...
  return (
    <form onSubmit={handleSubmit}>
      <section className="max-padd-container flexCenter flex-col pt-32 bg-primary ">
        <div className="w-full max-w-[400px] h-[600px] bg-primary m-auto px-14 py-10 rounded-full ">
          ...
          <div className="flex flex-col gap-4 mt-7 mb-7">
            <input
              ...
              required
              className="h-10 w-full pl-5 pr-10 rounded-md border-2 border-gray-300 focus:border-blue-500 focus:ring-blue-500 focus:ring-1 text-sm outline-none w-200px"
            />
            <input
              name="email"
              value={email}
